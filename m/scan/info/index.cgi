...
404_ips() {
cat /var/log/apache2/tools.tecmint.com-access.log | grep 404 | awk '{print $1, $4, $9, $7}' | grep -v 200 | awk '{print $1, $2}'  | cut -d: -f1| sed 's/\[/\ /g' | uniq -c | sort -nr
}

404_ips_files() {
cat /var/log/apache2/tools.tecmint.com-access.log | grep 404 | awk '{print $1, $9, $7, $4}' | grep -v 200 | sed 's/\[/\ /g' | cut -d: -f1 | awk '{print $4, $1, $3}' | uniq -c | sort -nr
 }
